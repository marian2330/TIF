...
import Carga from "./Carga"; // Importa el componente Carga
...
function Profile() {
    ...
    if (isLoadingProfile || isLoadingUpdate || isLoadingUserStates) {
        return <Carga />; // Muestra el componente de carga mientras se obtienen los datos
    }

    if (isErrorProfile) {
        return <p>Error al cargar perfil: {isErrorProfile.message}</p>;
    }
                                        ...
                                        <div className="control">
                                            <div className="select is-small">
                                                ...
                                                >
                                                    ...
                                                    {userStates && userStates.results.length > 0 ? (
